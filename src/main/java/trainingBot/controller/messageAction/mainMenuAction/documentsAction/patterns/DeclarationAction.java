...
@Component
public class DeclarationAction implements TriggerAction {
    private final Sendler sendler;
    private final Properties pattern = new Properties();


    public DeclarationAction(Sendler sendler) {
    ...
    public void execute(Update update) {
        String link = pattern.getProperty("patterns.declaration");
        sendler.sendLink(update.getMessage().getChatId(), "Заявления", link);
    }
}