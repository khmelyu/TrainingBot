...
public interface Ambassador2024Repository extends JpaRepository<Ambassador2024, Long> {
    ...
    @Query (value = "SELECT test_1_answer from ambassador_2024 where id =:id", nativeQuery = true)
    String teamAnswerTest(@Param("id") Long id);

    @Query (value = "SELECT word_1_answer from ambassador_2024 where id =:id", nativeQuery = true)
    String teamAnswerOneWord(@Param("id") Long id);

    @Query (value = "SELECT letter_1_answer from ambassador_2024 where id =:id", nativeQuery = true)
    String teamAnswerLetter(@Param("id") Long id);

    @Query (value = "SELECT media_1_answer from ambassador_2024 where id =:id", nativeQuery = true)
