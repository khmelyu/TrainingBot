...
public enum Callback {
    ...
    AMBASSADOR_YES("Да", "AMBASSADOR_YES"),
    AMBASSADOR_EXCELLENT("Отлично!", "AMBASSADOR_EXCELLENT"),
    AMBASSADOR_READY("Всегда готова!", "AMBASSADOR_READY"),
    AMBASSADOR_CREATE_TEAM("Создать команду", "AMBASSADOR_CREATE_TEAM"),
    AMBASSADOR_JOIN_TEAM("Вступить в команду", "AMBASSADOR_JOIN_TEAM"),
